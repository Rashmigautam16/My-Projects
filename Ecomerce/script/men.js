...
var mensData = [
  ...
  let arr=JSON.parse(localStorage.getItem('Mens'))||[];
  

function getdata(mensData){
...
function gotcart(el){
 arr.push(el)
 console.log(arr)
  localStorage.setItem("Mens",JSON.stringify(arr));
